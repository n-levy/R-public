...
## Table of contents
1. Introduction
2. Data set creation and exploration
...
knitr::opts_knit$set(root.dir = '/tmp') # applying the working directory setting to subsequent chunks in R Markdown
...
Sys.time() # recording the start time in order to see how long this takes
...
Sys.time() # recording the finish time in order to see how long it took
